...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core", "@angular/common/http", "../block-ui.module", "./block-ui-http.service"], factory);
    }
    ...
    var block_ui_http_service_1 = require("./block-ui-http.service");
    var BlockUIHttpModule = /** @class */ (function () {
        ...
        BlockUIHttpModule.forRoot = function (settings) {
            ...
            block_ui_module_1.BlockUIServiceInstance.updateSettings({ http: settings });
            return {
                ngModule: BlockUIHttpModule_1,
                providers: [
                    {
                        provide: http_1.HTTP_INTERCEPTORS,
                        useClass: block_ui_http_service_1.BlockUIInterceptor,
                        multi: true
                    }
                ]
            };

...
export class EmployerService extends HttpDataAbstract<Employer> {
  ...
  sendCreate(employers: Array<Employer>): Observable<Employer> {
    return this.http.post<Employer>(`${this.api}/employers/${employers[0].id}/send/create`, null);
  }
  ...
  sendUpdate(employers: Array<Employer>): Observable<Employer> {
    return this.http.post<Employer>(`${this.api}/employers/${employers[0].id}/send/update`, null);
  }
  ...
  sendDelete(employers: Array<Employer>): Observable<Employer> {
    return this.http.post<Employer>(`${this.api}/employers/${employers[0].id}/send/delete`, null);
  }
}
